...
import Arkode.zword.GoBicycle.Actor.HighScore;
import Arkode.zword.GoBicycle.Actor.Info;
...
public class HighScoreScreen implements Screen , GestureListener {
	
	private Stage stage;
	private HighScore highScore;
	private GoBicycle game;
	
	public HighScoreScreen(GoBicycle game) {
